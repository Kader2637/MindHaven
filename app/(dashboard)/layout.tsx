    ...
    <div className="flex h-screen bg-[#FDFDFD] relative overflow-hidden font-sans text-slate-900">
      ...
      `}>
        <div className="p-8 pb-10 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.4em] leading-none mb-1">Aether</p>
              <p className="text-xs font-black text-slate-900 uppercase tracking-widest leading-none">MindHaven</p>
            </div>
          </div>
        ...
        <div className="p-4 space-y-2 shrink-0">
          ...
          <div className="mt-4 p-4 bg-slate-50 rounded-[2rem] flex items-center gap-3 border border-slate-100">
            ...
            <div className="overflow-hidden">
              <p className="text-[10px] font-black text-slate-900 uppercase truncate">{userEmail?.split('@')[0] || 'Aetherian'}</p>
              <button 
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-50 flex items-center justify-between px-6 md:px-12 shrink-0 z-50">
          ...
          <div className="hidden lg:block text-sm font-bold text-slate-400">
            <span className="text-slate-900">Aether</span> <span className="mx-2">/</span> {menuItems.find(i => i.href === pathname)?.name || "Halaman"}
          </div>
